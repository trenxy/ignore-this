G.AddData({
name:'nondefault dataset',
author:'Orteil',
desc:'not default dataset for Legacy.',
engineVersion:1,
manifest:0,
func:function()
{
	...
	*/
	...
	G.props['fastTicksOnResearch']=1500;
	...
	G.funcs['new year']=function()
	{
		...
		{
			var str='';
			str+='It is now the year '+(G.year+100000000)+'.<br>';
			...
			G.getRes('born this year').amount=100000000000;
